...
def create_sweet_scent() -> int:
    ...
    skill = Skill(
            ...
            mod=-1,
            stage_effect=StageEffect.evasion
            )
    db.add(skill)
    db.commit()
    db.refresh(skill)
...
def test_sweet_scent_damage(test_db):
    ...
    teach_skill(hero_id, create_sweet_scent())
